...
void showFileMenu(std::vector<std::string>& tasks, const std::string& filename); // 新增：文件操作菜单
...
// 新增：文件操作菜单
void showFileMenu(std::vector<std::string>& tasks, const std::string& filename) {
